W przedstawionym repozytorium znajdują się dwa przypadki biznesowe, które pokazują wykorzystanie subzapytania, technik łączenia tabel (join) oraz CTE (Common Table Expressions) w SQL.
